...
const EditInstanceComponent: React.FC<EditInstanceComponentProps> = ({ instance }) => {
  ...
  return (
    <div className="group w-full flex justify-between ps-2 pe-4 items-center py-3 hover:bg-slate-100 hover:shadow-md cursor-pointer px-4 hover:border-l-[6px] hover:border-l-primary" onClick={() => openAiInstance(instance.editId)}>
